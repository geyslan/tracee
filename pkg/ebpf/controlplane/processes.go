...
func (ctrl *Controller) procTreeForkProcessor(args []trace.Argument) error {
	...
	forkFeed.TimeStamp = uint64(ctrl.timeNormalizer.NormalizeTime(int(forkFeed.TimeStamp)))
	forkFeed.ChildStartTime = uint64(ctrl.timeNormalizer.NormalizeTime(int(forkFeed.ChildStartTime)))
	forkFeed.ParentStartTime = uint64(ctrl.timeNormalizer.NormalizeTime(int(forkFeed.ParentStartTime)))
	forkFeed.LeaderStartTime = uint64(ctrl.timeNormalizer.NormalizeTime(int(forkFeed.LeaderStartTime)))
...
func (ctrl *Controller) procTreeExecProcessor(args []trace.Argument) error {
	...
	execFeed.TimeStamp = uint64(ctrl.timeNormalizer.NormalizeTime(int(execFeed.TimeStamp)))
...
func (ctrl *Controller) procTreeExitProcessor(args []trace.Argument) error {
	...
	exitFeed.TimeStamp = uint64(ctrl.timeNormalizer.NormalizeTime(int(exitFeed.TimeStamp)))
